...
def get_trace_fast(distance):
    ...
    track.append([0, 0, 0])
    rand_x = int(distance * random.randint(2, 8) / 10)
    track.append([rand_x, random.randint(-2, 2), random.randint(200, 300)])
    track.append([distance - rand_x, random.randint(-2, 2), random.randint(300, 350)])
    track.append([distance,  random.randint(-2, 2), random.randint(350, 400)])
    return track
