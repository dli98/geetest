...
'\x77\x66': function(A8Q) {
    ...
    for (; T79 !== M0V.V0V()[26][11][11]; ) { //Jov[23]
        switch (T79) {
        case M0V.V0V()[25][11][23]: //J[35]
            var B8Q = this;   //aeskey: "6ffe9f84a1cd9625"
            return B8Q["B"]["aeskey"] && !A8Q || (B8Q["B"]["aeskey"] = O4()), B8Q["B"]["aeskey"];
            break;
        }
    }
},
...
'\x79\x66': function(a8Q) {  //
    var w79 = M0V.V0V()[15][35][23];   //JOV[35]
    for (; w79 !== M0V.V0V()[7][32][16][32]; ) {  //JOV[20]
        switch (w79) {
        case M0V.m0V()[28][22][22]:  //J[10)
            var v8Q = this
              , Y8Q = new L4()["encrypt"](v8Q["wf"](a8Q));
            w79 = M0V.m0V()[8][11][11]; // J(23)
            break;
        case M0V.m0V()[20][23][23]:  // J[35]
            var f7q = 5;
            w79 = M0V.m0V()[1][22][22]; //J[10]
            break;
        case M0V.V0V()[4][35][11]: // J[23]
            w79 = (!Y8Q || 256 !== Y8Q["length"]) && f7q * (f7q + 1) * f7q % 2 == 0 ?
                M0V.V0V()[2][13][1] : M0V.m0V()[25][26][2];
                /* J[25]  : J[14]*/
            break;
        case M0V.V0V()[12][25][1]: // J[25]
            Y8Q = new L4()["encrypt"](v8Q["wf"](!0));
            w79 = M0V.V0V()[32][19][7];  //J[31]
            break;
        case M0V.m0V()[0][14][2]:  //J[14]
            return Y8Q;
            break;
        case M0V.V0V()[17][19][8][19]: //J[31]
            f7q = f7q > 71903 ? f7q / 4 : f7q * 4;
            w79 = M0V.m0V()[4][35][11]; //J[23]
            break;
        }
    }
},
...
function P0() {
    ...
    this["setPublic"](M0V.d1q(743), M0V.d1q(1146));  //ƒ V2(t3X,Q3X)
}
