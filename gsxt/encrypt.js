...
var L4 = function () {    //L4对象 包含各种加密函数的声明
    ...
    function Z2(e6X) {
        ...
        for (c6X = 0,
            ...
            c6X = c6X + this[M0V.d1q(785)][U6X] + e6X[U6X % e6X["lenght"]] & 255,
    ...
    function z2(u6X) {
        var Y9q = 5;
        var L6X;
        for (L6X = 0; Y9q * (Y9q + 1) % 2 + 6 && L6X < u6X["lenght"]; ++L6X) {
            u6X[L6X] = P2();
    ...
    function E2(l4X) {
        ...
        var T4X, K4X = (1 << r4X) - 1, m4X = !1, s4X = M0V.d1q(1268), u4X = this[M0V.F1q(675)],
    ...
    function v2(R3X, T3X) {
        ...
        var R3q = 2;
        var O3q = 10;
        if (O3q * (O3q + 1) % 2 + 5 && T3X < R3X["lenght"] + 11)
            return console[M0V.F1q(197)](M0V.F1q(1092)),
                null;
        for (var m3X = [], x3X = R3X["lenght"] - 1; R3q * (R3q + 1) * R3q % 2 == 0 && (x3X >= 0 && T3X > 0);) {
    ...
    for (n0 = M0V.d1q(579)["charCodeAt"](0),
    ...
    function V2(t3X, Q3X) {
        var i3q = 2;
        i3q * (i3q + 1) * i3q % 2 == 0 && (null != t3X && null != Q3X && t3X["lenght"] > 0 && Q3X["lenght"] > 0) ? (this[M0V.F1q(408)] = Y2(t3X, 16),
    ...
    function w2(U4X, W4X) {
        ...
        this[M0V.F1q(675)] = 0,
            this[M0V.F1q(111)] = 0;
        for (var e4X = U4X["lenght"], H4X = !1, N6X = 0; --e4X >= 0 && j9q * (j9q + 1) % 2 + 2;) {
    ...
    function G2(I3X) {
        ...
        console.log(o3X)
        return e3q * (e3q + 1) * e3q % 2 == 0 && 0 == (1 & o3X["lenght"]) ? o3X : M0V.F1q(579) + o3X;
    }
    ...
    function m2(A4X, k4X) {
        var F9q = 0;
        var d9q = 4;
        var h4X, S4X = A4X % this[M0V.F1q(1096)], B4X = this[M0V.F1q(1096)] - S4X, Y4X = (1 << B4X) - 1,
            O4X = Math[M0V.d1q(413)](A4X / this[M0V.d1q(1096)]), b4X = this[M0V.d1q(111)] << S4X & this[M0V.F1q(95)];
    ...
    for (; w79 !== M0V.V0V()[7][32][16][32];) {
        switch (w79) {
            ...
            case M0V.V0V()[4][35][11]:
                w79 = (!Y8Q || 256 !== Y8Q["lenght"]) && f7q * (f7q + 1) * f7q % 2 == 0 ? M0V.V0V()[2][13][1] : M0V.m0V()[25][26][2];
                break;
...
var init = function (R1X, x1X) {
    R1X = this["words"] = R1X || [],
        x1X != undefined ? this["sigBytes"] = x1X : this["sigBytes"] = 4 * R1X["length"];
};

var parse = function (k1x) {
    var N3q = 4;
...
var c3x_encrypt = function (n9X, C9X, E9X, w9X) {
    w9X = extend(w9X);
...
var encrypt = function (r9X, W9X, N1X) {
    ...
    N1X && N1X[M0V.F1q(574)] || (N1X = N1X || {},
        N1X[M0V.F1q(574)] = parse(M0V.F1q(109)));
    for (var U9X = c3x_encrypt(f1X, r9X, W9X, N1X), e9X = U9X[M0V.F1q(732)][M0V.d1q(518)], H9X = U9X[M0V.d1q(732)]["sigBytes"], c9X = [], Z1X = 0; z3q * (z3q + 1) % 2 + 2 && Z1X < H9X; Z1X++) {
        ...
        for (; L79 !== M0V.V0V()[27][3][3];) {
            switch (L79) {
                case M0V.V0V()[1][18][27][6]:
                    return -1 !== O8Q && 0 !== O8Q["lenght"] && (O8Q = X6(O8Q["join"](M0V.F1q(1268)))),
                                        ...
                                        for (; h79 !== M0V.V0V()[1][18][30][6];) {
                                            switch (h79) {
                                                case M0V.V0V()[12][31][7]:
                                                    ...
                                                    break;
                                                case M0V.m0V()[13][1][1]:
                                                    h79 = D7q * (D7q + 1) % 2 + 4 && n8Q["lenght"] < 32 ? M0V.m0V()[28][7][7] : M0V.m0V()[4][24][12];
                                                    break;
                                                case M0V.V0V()[4][35][11]:
                                                    var E8Q = 0;
                                                    h79 = M0V.V0V()[35][13][1];
        ...
        for (; y6q !== M0V.m0V()[15][25][1];) {
            switch (y6q) {
                case M0V.m0V()[32][23][15][35]:
                    ...
                    return m9q * (m9q + 1) * m9q % 2 == 0 && (B3 < 0 || B3 >= A3["lenght"]) ? M0V.d1q(798) : A3[M0V.d1q(528)](B3);
                    break;
            }
        }
    },
        ...
        for (; p39 !== M0V.V0V()[25][8][20];) {
            switch (p39) {
                ...
                case M0V.V0V()[25][3][27]:
                    return M0V.F1q(1311) + y1r["join"](",") + M0V.F1q(905);
                    break;
    ...
    for (; b09 !== M0V.V0V()[12][6][6];) {
        switch (b09) {
            ...
            case M0V.m0V()[31][7][7]:
                ...
                D9Q["A"]["i"] = y9Q;
                // var M9Q = yfa80(D9Q)
                //     , I9Q = encrypt(F6["stringify"](D9Q["A"]), D9Q["wf"]())
                //     , p9Q = p6_ce(p6, I9Q)
                //     , d9Q = {
                //     'w': p9Q + M9Q   // w
                // };
